...
function CodeView() {
  ...
  return (
    <div className="relative">
      ...
      <SandpackProvider
        files={files}
        key={activeTab === 'preview' ? 'preview-' + JSON.stringify(files) : 'code'}
        template="react"
        theme={'dark'}
        customSetup={{
          dependencies: {
        ...
        options={{ externalResources: ['https://cdn.tailwindcss.com','https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js'] }}
      >
        <SandpackLayout>
          {activeTab == 'code' ? (
            <>
            ...
            <>
              <SandpackPreviewClient key={activeTab + JSON.stringify(files)}/>
            </>
          )}
        </SandpackLayout>
      </SandpackProvider>
